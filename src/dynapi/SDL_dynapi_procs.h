...
SDL_DYNAPI_PROC(SDL_Surface*,SDL_WriteLockSharedSurface,(SDL_SharedSurface *a),(a),return)
SDL_DYNAPI_PROC(SDL_Surface*,SDL_ReadLockSharedSurface,(SDL_SharedSurface *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_UnlockSharedSurface,(SDL_SharedSurface *a),(a),)
